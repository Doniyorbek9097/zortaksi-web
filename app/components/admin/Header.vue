<template>
  <header class="flex items-center justify-between gap-2.5 sticky top-0 z-30 -mx-4 px-4 py-2.5 bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur-lg border-b border-slate-200/50 dark:border-slate-800/50">
    <div class="flex items-center gap-2.5 min-w-0">
      <div
        class="w-9 h-9 rounded-xl flex items-center justify-center text-base text-white shrink-0 bg-gradient-to-br from-sky-500 to-blue-600 shadow-md shadow-sky-500/20"
      >
        <font-awesome-icon icon="fa-solid fa-car" />
      </div>
      <div class="leading-tight min-w-0">
        <h1 class="text-[15px] font-black tracking-tight truncate">
          <span class="text-sky-600 dark:text-sky-400">ZorTaksi</span><span class="text-red-500">.uz</span>
        </h1>
        <p class="text-[9px] font-bold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 mt-0.5">
          Admin
        </p>
      </div>
    </div>
