<template>
  <div v-if="chips.length" class="flex flex-wrap gap-1.5">
    <span
      v-for="chip in chips"
      :key="chip"
      class="inline-flex items-center gap-1.5 max-w-full pl-2.5 pr-1.5 py-1 rounded-full text-[12px] font-bold bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-400/30 dark:border-indigo-500/30"
    >
