<template>
  <div class="relative min-h-[100dvh] overflow-hidden flex flex-col items-center px-4 py-8 text-slate-900 dark:text-slate-100">
    <!-- Atmosphere -->
          ...
          <div class="rounded-2xl border border-[#2AABEE]/25 bg-[#2AABEE]/8 dark:bg-[#2AABEE]/10 px-4 py-3.5 flex items-start gap-3">
            ...
            <div class="min-w-0 space-y-1">
              ...
              <p class="text-[11px] font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                Qo‘shimcha Telegram akkaunt raqamini kiriting. Kod SMS emas — Telegram ilovasiga keladi.
              </p>
            </div>
          </div>
